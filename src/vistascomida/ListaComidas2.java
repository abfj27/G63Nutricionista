...
public class ListaComidas2 extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jbBaja = new rsbuttom.RSButtonMetro();
        jbAlta = new rsbuttom.RSButtonMetro();
        jbNuevo = new rsbuttom.RSButtonMetro();
    ...
    private rsbuttom.RSButtonMetro jbAlta;
    private rsbuttom.RSButtonMetro jbBaja;
    private rsbuttom.RSButtonMetro jbCerrar1;
    private rsbuttom.RSButtonMetro jbModificar;
    private rsbuttom.RSButtonMetro jbNuevo;
