...
public class ListaDietaVen2 extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jbDetallesDieta = new rsbuttom.RSButtonMetro();
        jbModificarDieta1 = new rsbuttom.RSButtonMetro();
        jbNuevaDieta = new rsbuttom.RSButtonMetro();
        jbEditarComidas = new rsbuttom.RSButtonMetro();
    ...
    private rsbuttom.RSButtonMetro jbDetallesDieta;
    private rsbuttom.RSButtonMetro jbEditarComidas;
    private rsbuttom.RSButtonMetro jbModificarDieta1;
    private rsbuttom.RSButtonMetro jbNuevaDieta;
